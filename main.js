	...
	function (flags, url, key) {
		...
		if (_v0.$ === 'Err') {
			...
			if (problem.$ === 'UrlProblem') {
				...
				var prob = problem;
				return _Utils_Tuple2(
					{data: $author$project$Main$Loading, key: key, problem: prob, view: $author$project$Main$ProblemView, zone: $elm$core$Maybe$Nothing},
					cmd);
			}
		} else {
			var okView = _v0.a;
			return _Utils_Tuple2(
				{data: $author$project$Main$Loading, key: key, problem: $author$project$Main$NoProblem, view: okView, zone: $elm$core$Maybe$Nothing},
				cmd);
		}
	});
